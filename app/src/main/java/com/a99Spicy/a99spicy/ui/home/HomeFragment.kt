...
import com.a99Spicy.a99spicy.ui.*
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        homeCategoryAdapter.submitList(AppUtils.getCategoryList())
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        activity.setToolbarLogo(ContextCompat.getDrawable(requireContext(),R.drawable.ic_action_white_logo))
        ...
        when (requestCode) {
            REQUEST_FOREGROUND_ONLY_PERMISSIONS_REQUEST_CODE -> when {
                ...
                grantResults[0] == PackageManager.PERMISSION_GRANTED -> {
                    ...
                    builder.setPositiveButton(getString(R.string.settings),DialogInterface.OnClickListener { dialog, which ->
